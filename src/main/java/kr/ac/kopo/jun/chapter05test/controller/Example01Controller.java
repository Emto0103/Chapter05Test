...
public class Example01Controller {
    ...
    public String requestMethod6(@PathVariable("id1") String userId1, @MatrixVariable(value = "passwd", pathVar="id1") String userPw1,
                                 @PathVariable("id2") String userId2, @MatrixVariable(value = "passwd", pathVar="id2") String userPw2, Model model)  {
        model.addAttribute("data1", "@PathVariable 연습");
        model.addAttribute("data2", "PathVariable에 전달된 id값:" + userId1
                                                            + "MatrixVariable에 전달된 pwd1 값:" + userPw1 +
                                                            "<brPathVariable에 전달된 id1 값:" + userId2 +
                                                            "MatrixVariable에 전달된 pwd1 값:" + userPw2);
        return "viewPage";
    }
    ...
    public String requestMethod8(@MatrixVariable MultiValueMap<String, String> var1,
        ...
        model.addAttribute("data2", var1 + "<p>" + var2 + "</p>");
        return "viewPage";
    }
}
